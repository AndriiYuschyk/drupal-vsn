 ...
 * @endcode
 */
$settings['hash_salt'] = 't69cVS5t2kzhx2zDpM05PwkYcjvlWOiLzezmV1YALtY4UfK8soH2amMCK7rc16lNSGklUko3Mg';
...
$settings['trusted_host_patterns'] = [
    ...
    '^127\.0\.0\.1$',
    '^127\.0\.0\.1:8080$',
    '^drupal_main$', // ім'я контейнера, якщо відкриваєш ізсередини мережі
];
